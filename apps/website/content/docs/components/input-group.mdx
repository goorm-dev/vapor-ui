...
import { InputGroup, TextInput, Textarea } from '@vapor-ui/core';

export default function InputGroupBasic() {
    return (
        <div className="space-y-4">
            <InputGroup.Root>
                <TextInput placeholder="텍스트 입력 (최대 50자)" maxLength={50} />
                <InputGroup.Counter />
            </InputGroup.Root>
            <InputGroup.Root>
                <Textarea placeholder="텍스트 영역 (최대 100자)" maxLength={100} rows={3} />
                <InputGroup.Counter />
            </InputGroup.Root>
            <InputGroup.Root>
                <TextInput placeholder="글자 수 제한 없음" />
                <InputGroup.Counter />
            </InputGroup.Root>
        </div>
    );
