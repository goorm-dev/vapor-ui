...
export default function DefaultNavigationMenu() {
    return (
        <NavigationMenu.Root size="md" shape="fill" aria-label="Navigation menu">
            <NavigationMenu.List>
                <NavigationMenu.Item>
        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                <div className="space-y-3">
                    <NavigationMenu.Root shape="fill" aria-label="Fill navigation with selection">
                        <NavigationMenu.List>
                    ...
                    <NavigationMenu.Root shape="ghost" aria-label="Ghost navigation with selection">
                        <NavigationMenu.List>
                            <NavigationMenu.Item><NavigationMenu.Link href="#">일반</NavigationMenu.Link></NavigationMenu.Item>
...
export default function NavSimple() {
    return (
        <NavigationMenu.Root size="md" shape="fill" aria-label="Simple navigation">
            <NavigationMenu.List>
