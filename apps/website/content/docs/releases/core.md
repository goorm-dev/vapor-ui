---
title: Core
description: '@vapor-ui/core 패키지의 릴리즈 노트입니다.'
---
...
- add new `Meter` component ([#700](https://github.com/goorm-dev/vapor-ui/pull/700)) - Thanks [@MaxLee-dev](https://github.com/MaxLee-dev)!
