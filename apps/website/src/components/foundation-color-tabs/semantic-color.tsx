        ...
        <Box paddingY="$400">
            ...
            <ColorPalette
                colors={[
                    ...
                    { name: 'Background Canvas', variable: 'background-canvas' },
                    { name: 'Background Surface 100', variable: 'background-surface-100' },
                    {
                        name: 'Background Surface 200',
                        variable: 'background-surface-200',
                        foreground: 'gray-950',
                    },
                ]}
            />
            ...
            <ColorPalette
                colors={[
                    { name: 'Border Primary', variable: 'border-primary', foreground: 'gray-000' },
                    {
                        name: 'Border Secondary',
                        variable: 'border-secondary',
                        foreground: 'gray-950',
                    },
                    { name: 'Border Success', variable: 'border-success', foreground: 'gray-000' },
                    { name: 'Border Warning', variable: 'border-warning', foreground: 'gray-000' },
                    { name: 'Border Danger', variable: 'border-danger', foreground: 'gray-000' },
                    { name: 'Border Hint', variable: 'border-hint', foreground: 'gray-000' },
                    {
                        name: 'Border Contrast',
                        variable: 'border-contrast',
                        foreground: 'gray-000',
                    },
                    { name: 'Border Normal', variable: 'border-normal', foreground: 'gray-950' },
                ]}
            />
