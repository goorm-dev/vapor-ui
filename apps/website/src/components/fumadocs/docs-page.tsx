...
export function DocsBody({ children, className, ...props }: ComponentProps<'div'>) {
    return (
        <div {...props} className={clsx('prose flex-1', className)}>
            {children}
        </div>
    );
}
...
export function DocsDescription({ children, className, ...props }: ComponentProps<'p'>) {
    ...
    return (
        <p {...props} className={clsx('text-fd-muted-foreground mb-8 text-lg', className)}>
            {children}
        </p>
    );
}
...
export function DocsTitle({ children, className, ...props }: ComponentProps<'h1'>) {
    return (
        <h1 {...props} className={clsx('text-[1.75em] font-semibold', className)}>
            {children}
        </h1>
    );
}
