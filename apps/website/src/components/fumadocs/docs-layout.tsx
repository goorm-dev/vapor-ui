...
function DocsNavbar({
    ...
    return (
        <LayoutHeader
            id="nd-subnav"
            className={clsx(
                'data-[transparent=false]:bg-fd-background/80 layout:[--fd-header-height:--spacing(23)] sticky top-(--fd-docs-row-1) flex flex-col backdrop-blur-sm transition-colors [grid-area:header]',
