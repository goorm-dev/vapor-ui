...
const SCALE_VALUES = [0.8, 0.9, 1, 1.1, 1.2] as const;
...
const useCustomTheme = (): CustomThemeContextValue => {
...
export { CustomThemeProvider, useCustomTheme, RADIUS_VALUES, SCALE_VALUES };
export type { CustomThemeConfig, ScaleValue };
