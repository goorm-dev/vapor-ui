...
figma.ui.onmessage = async (msg: UIMessage) => {
    if (msg.type === 'create-palette-sections') {
        try {
            const { generatedPalette } = msg.data;
...
function createPaletteSections(generatedPalette: Pick<ColorPaletteCollection, 'light' | 'dark'>) {
...
function createThemeSection(theme: 'light' | 'dark', themeData: ColorPaletteCollection['light']) {
    // Create section
...
function createPaletteTable(generatedThemeData: ColorPaletteCollection['light'], theme: string) {
...
function createPaletteHeader(theme: string) {
...
function createColorRow(colorName: string, hexColor: string, oklchColor?: string) {
