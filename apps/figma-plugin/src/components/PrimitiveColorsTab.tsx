...
export const PrimitiveColorsTab = () => {
    ...
    return (
        <>
            {/* Primitive Colors */}
            <div className="mb-6">
                <div className="text-sm font-medium text-gray-600 mb-2">Primitive Colors</div>
            ...
            <div className="mb-6">
                <div className="text-sm font-medium text-gray-600 mb-2">Background Lightness</div>
                <div className="mb-2">
            ...
            {/* Contrast Ratios */}
            <div className="mb-6">
                <div className="text-sm font-medium text-gray-600 mb-2">Contrast Ratios</div>
