/**
 * This file is adapted from Base UI's createBaseUIEventDetails utility.
 *
 * Original source:
 * https://github.com/mui/base-ui/blob/master/packages/react/src/utils/createBaseUIEventDetails.ts
 *
 * Copyright (c) 2024 Material-UI
 ...
 */
export type MakeChangeEventDetails<Reason extends string, CustomProperties extends object = {}> = {
    [K in Reason]: {
        /**
...
/**
 * Creates a event details object with the given reason and utilities
...
): MakeChangeEventDetails<Reason, CustomProperties> {
    let canceled = false;
...
): GenericEventDetails<Reason, EventType, CustomProperties> {
