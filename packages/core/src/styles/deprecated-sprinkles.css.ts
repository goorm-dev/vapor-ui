/**
 * @deprecated This file contains deprecated sprinkles styles.
 * Please use `sprinkles.css.ts` instead.
 */
...
export const deprecatedSprinkles = createRainbowSprinkles(sprinkleProperties);
