...
//     return (
//         <RadioGroup.Root {...props}>
//             <RadioGroup.Item value="option1" render={<div />}>
//                 <RadioGroup.Control id="option1" />
//                 <label htmlFor="option1">{OPTION_1}</label>
//             </RadioGroup.Item>
//             <RadioGroup.Item value="option2" render={<div />}>
//                 <RadioGroup.Control id="option2" />
//                 <label htmlFor="option2">{OPTION_2}</label>
//             </RadioGroup.Item>
//         </RadioGroup.Root>
//     );
...
//             >
//                 <RadioGroup.Root name="radio-group-test">
//                     <RadioGroup.Item value="a" render={<div />}>
//                         <label htmlFor="a">a</label>
//                         <RadioGroup.Control id="a" />
//                     </RadioGroup.Item>
//                     <RadioGroup.Item value="b" render={<div />}>
//                         <label htmlFor="b">b</label>
//                         <RadioGroup.Control id="b" />
//                     </RadioGroup.Item>
//                 </RadioGroup.Root>
...
//                     <label htmlFor="option2">option2</label>
//                 </RadioGroup.Item>
//                 <RadioGroup.Item value="option3" render={<div />}>
//                     <RadioGroup.Control id="option3" />
//                     <label htmlFor="option3">option3</label>
//                 </RadioGroup.Item>
//             </RadioGroup.Root>,
//         );
...
//                     <label htmlFor="option1">option1</label>
//                 </RadioGroup.Item>
//                 <RadioGroup.Item value="option2" disabled render={<div />}>
//                     <RadioGroup.Control id="option2" />
//                     <label htmlFor="option2">option2</label>
//                 </RadioGroup.Item>
//                 <RadioGroup.Item value="option3" render={<div />}>
