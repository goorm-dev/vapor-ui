...
const BulgariaColorIcon = (props: IconProps) => (
    <IconBase xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" {...props}>
        <mask
            id="vapor-icons-color-BulgariaColorIcon__a"
            width={16}
            height={16}
            x={0}
            y={0}
        ...
        <g mask="url(#vapor-icons-color-BulgariaColorIcon__a)">
            <path fill="#fff" d="M21.093.098h-26.47v5.426h26.47z" />
            <path
                fill="#F2F2F0"
            ...
            />
            <path fill="#00966E" d="M21.193 5.333H-5.475v5.332h26.668z" />
            <path fill="#D62612" d="M21.193 10.667H-5.475V16h26.668z" />
        </g>
    </IconBase>
);
