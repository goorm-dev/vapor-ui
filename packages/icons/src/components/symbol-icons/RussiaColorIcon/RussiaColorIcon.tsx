...
const RussiaColorIcon = (props: IconProps) => (
    <IconBase viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <g mask="url(#mask0_9214_1351)">
            <path d="M19.8346 0.0217896H-4.12V5.30905H19.8346V0.0217896Z" fill="white" />
            <path
                ...
                fill="#F2F2F0"
            />
            <path d="M19.8582 5.3327H-4.14178V10.6654H19.8582V5.3327Z" fill="#0039A6" />
            <path d="M19.8582 10.6673H-4.14178V16H19.8582V10.6673Z" fill="#D52B1E" />
        </g>
    </IconBase>
);
