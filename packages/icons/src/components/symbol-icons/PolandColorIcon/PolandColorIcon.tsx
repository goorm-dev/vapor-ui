...
const PolandColorIcon = (props: IconProps) => (
    <IconBase xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" {...props}>
        <mask
            id="vapor-icons-color-PolandColorIcon__a"
            width={16}
            height={16}
            x={0}
            y={0}
        ...
        <g mask="url(#vapor-icons-color-PolandColorIcon__a)">
            <path fill="#fff" d="M20.558.1h-25.4v7.885h25.4z" />
            <path
                fill="#F2F2F0"
            ...
            />
            <path fill="#DC143C" d="M20.658 8h-25.6v8h25.6z" />
        </g>
    </IconBase>
);
