...
const MadagascarColorIcon = (props: IconProps) => (
    <IconBase viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <g mask="url(#mask0_9214_1276)">
            <path d="M7.45255 0.0908203H-0.956543V15.909H7.45255V0.0908203Z" fill="white" />
            <path
                ...
                fill="#F2F2F0"
            />
            <path d="M22.9474 -6.10352e-05H6.93652V7.99994H22.9474V-6.10352e-05Z" fill="#FC3D32" />
            <path d="M22.9474 7.99994H6.93652V15.9999H22.9474V7.99994Z" fill="#007E3A" />
        </g>
    </IconBase>
);
