...
const JapanColorIcon = (props: IconProps) => (
    <IconBase xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" {...props}>
        <mask
            id="vapor-icons-color-JapanColorIcon__a"
            width={16}
            height={16}
            x={0}
            y={0}
        ...
        <g mask="url(#vapor-icons-color-JapanColorIcon__a)">
            ...
            <path
                fill="#BC002D"
                d="M8 12.796a4.796 4.796 0 1 0 0-9.592 4.796 4.796 0 0 0 0 9.592"
            />
        </g>
    </IconBase>
);
