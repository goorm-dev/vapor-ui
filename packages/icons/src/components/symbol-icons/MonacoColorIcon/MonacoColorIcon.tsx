...
const MonacoColorIcon = (props: IconProps) => (
    <IconBase xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" {...props}>
        <mask
            id="vapor-icons-color-MonacoColorIcon__a"
            width={16}
            height={16}
            x={0}
            y={0}
        ...
        <g mask="url(#vapor-icons-color-MonacoColorIcon__a)">
            <path fill="#fff" d="M17.758 7.795h-19.8V15.9h19.8z" />
            <path
                fill="#F2F2F0"
            ...
            />
            <path fill="#CE1126" d="M17.858 0h-20v8h20z" />
        </g>
    </IconBase>
);
