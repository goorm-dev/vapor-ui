...
/**
 * Analyzes React components to extract default rendering elements
 * and display names
 */
export class ComponentAnalyzer {
     ...
     */
    extractDisplayName(symbol: ts.Symbol): string | undefined {
     ...
     */
    extractDefaultElement(symbol: ts.Symbol): string | undefined {
        const declarations = symbol.getDeclarations();
        if (!declarations) return undefined;
