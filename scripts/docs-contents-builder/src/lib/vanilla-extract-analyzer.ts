...
/**
 * Analyzes Vanilla Extract CSS files to extract default values
 * and component styling information
 */
export class VanillaExtractAnalyzer {
     ...
     */
    findCssFile(componentFilePath: string): string | undefined {
     ...
     */
    extractDefaultValue(cssFilePath: string, propName: string): string | undefined {
